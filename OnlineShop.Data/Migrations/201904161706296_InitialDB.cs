    ...
    public partial class InitialDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        CaterogyID = c.Int(nullable: false),
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.ProductCategories", t => t.CaterogyID, cascadeDelete: true)
                .Index(t => t.CaterogyID);
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.PostCategories", t => t.CaterogyID, cascadeDelete: true)
                .Index(t => t.CaterogyID);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Posts", "CaterogyID", "dbo.PostCategories");
            DropForeignKey("dbo.OrderDetails", "ProductID", "dbo.Products");
            DropForeignKey("dbo.Products", "CaterogyID", "dbo.ProductCategories");
            DropForeignKey("dbo.OrderDetails", "OrderID", "dbo.Orders");
            DropForeignKey("dbo.Menus", "GroupID", "dbo.MenuGroups");
            DropIndex("dbo.ProductTags", new[] { "ProductID" });
            DropIndex("dbo.ProductTags", new[] { "TagID" });
            DropIndex("dbo.Posts", new[] { "CaterogyID" });
            DropIndex("dbo.Products", new[] { "CaterogyID" });
